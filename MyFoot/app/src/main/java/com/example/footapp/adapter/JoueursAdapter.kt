...
class JoueursHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private  val  player_name  = itemView.findViewById<TextView>(R.id.comments)
    private  val player_number = itemView.findViewById<TextView>(R.id.player_number)
    private  val player_type = itemView.findViewById<TextView>(R.id.comments_date)
    ...
    fun bindView(joueur : Joueur){
        ...
        constraintLayout.setOnClickListener {
            ...
            JoueurObject.idJoueur = joueur.player_id
